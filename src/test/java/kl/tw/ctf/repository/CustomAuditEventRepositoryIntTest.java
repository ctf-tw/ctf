...
import kl.tw.ctf.config.audit.AuditEventConverter;
import kl.tw.ctf.domain.PersistentAuditEvent;
...
import static kl.tw.ctf.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
